...
wamv_detanu_t = wamv_detanu([U_WAMV;wamv_etanu]);
...
% ------------- WAMV DATA
% Gets WAMV IMU data
[Y_IMU, SR_IMU] = GetIMUData([wamv_etanu;wamv_detanu_t(7:12)], wamv_gyrobias);

% Gets WAMV GPS data
[Y_GPS, SR_GPS] = GetGPSData([wamv_etanu;wamv_detanu_t(7:12)]);

% Gets VB Data
[Y_VB,SR_VB]    = GetVBData([wamv_etanu;wamv_detanu_t(7:12)]);
