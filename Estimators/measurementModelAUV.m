...
auv_detanu_t = auv_detanu([U_AUV;auv_etanu]);
...
% Gets AUV IMU data
[Y_IMU, SR_IMU] = GetIMUData([auv_etanu;auv_detanu_t(7:12)], auv_gyrobias);

% Gets AUV HAP data
[Y_HAP, SR_HAP] = GetHAPData([auv_etanu;auv_detanu_t(7:12)], wamv_etanu);
