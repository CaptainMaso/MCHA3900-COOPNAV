...
param.WAMV.KN = 250; % Spring in E
param.WAMV.KdN = 100; % Damper in Nb
param.WAMV.KE = 200; % Spring in E
param.WAMV.KdE = 10; % Damper in Eb
param.WAMV.Kpsi = 250; % Spring in Psi
param.WAMV.Kdpsi = 200; % Spring in Psib
param.WAMV.Kdxpsi = 1;

% Initial and final conditions
param.WAMV.etai = [0; 0; 0; 0; 0; deg2rad(0); zeros(6,1)];
param.WAMV.etad = [100; 100; 0; 0; 0; deg2rad(0)];
